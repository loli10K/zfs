...
src1sub=$src1/src1sub
src2=$TESTPOOL/$TESTFS/src2
src2sub=$src2/src2sub
snap1=$src1@snap1
snap2=$src2@snap2
bkup1=/var/tmp/bkup1.$$
bkup2=/var/tmp/bkup2.$$
dst1=$TESTPOOL/$TESTFS/dst1
dst1sub=$dst1/dst1sub
dst2=$TESTPOOL/$TESTFS/dst2
dst2sub=$dst2/dst2sub
dsnap1=$dst1@snap1
dsnap2=$dst2@snap2
...
log_must $ZFS create $src2sub
log_must eval "$ZFS send -R $snap2 > $bkup2"
